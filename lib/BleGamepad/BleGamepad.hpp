...
typedef void (*onstarted_cb_t)(NimBLEServer *pServer);
...
private:
    ...
    onstarted_cb_t onstarted_cb = NULL;
...
public:
    ...
    void onConnect(onconnect_cb_t);
    void onDisconnect(ondisconnect_cb_t);
    void onStarted(onstarted_cb_t);
